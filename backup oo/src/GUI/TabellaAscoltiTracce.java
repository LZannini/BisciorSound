...
public class TabellaAscoltiTracce extends JFrame {
	 ...
	 * Create the frame.
	 */
	public TabellaAscoltiTracce(Controller c, JFrame frameChiamante) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(TabellaAscoltiTracce.class.getResource("/immagini/icona bs.png")));
		frame = this;
		controller = c;
		...
		btn_cover.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				TabellaAscoltiCover tabella_ascoltiCover = new TabellaAscoltiCover(c, frameChiamante);
