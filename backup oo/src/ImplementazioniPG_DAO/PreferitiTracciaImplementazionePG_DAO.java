...
public class PreferitiTracciaImplementazionePG_DAO implements PreferitiTracceDAO {
	...
	public JList mostra_preferiti(JList lista, Utente U) {
		...
		String query = "select nome from traccia, utente, preferiti_traccia where preferiti_traccia.id_utente = '"
				+ U.getUser_id() + "' and preferiti_traccia.id_traccia = traccia.id_track and  utente.username = '"
				+ U.getUsername() + "' order by traccia.nome";
